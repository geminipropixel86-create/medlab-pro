...
export function buildLabTest(overrides: Partial<LabTest> = {}): LabTest {
  ...
  test.sampleCollectedDate = overrides.sampleCollectedDate as any;
  test.resultDate = overrides.resultDate as any;
  test.assignedToId = overrides.assignedToId as any;
  test.parameters = overrides.parameters as any;
  test.notes = overrides.notes as any;
...
export function buildTestResult(overrides: Partial<TestResult> = {}): TestResult {
  ...
  result.pdfUrl = overrides.pdfUrl as any;
  result.isPatientNotified = overrides.isPatientNotified ?? false;
  result.verifiedById = overrides.verifiedById as any;
  result.verifiedAt = overrides.verifiedAt as any;
